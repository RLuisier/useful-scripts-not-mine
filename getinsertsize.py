...
Author: Wei Li
'''
#http://allaboutbioinfo.blogspot.co.uk/2012/04/estimating-paired-end-read-insert.html
...
#Compile: Compiling Regular Expressions into pattern objects, which have methods for various operations such as searching for pattern matches or performing string substitutions
objmrl=re.compile('([0-9]+)M$');
#Match 'XX'M (6th column of the sam file)
objmtj=re.compile('NH:i:(\d+)');
#Match NH:i:'XX' (16th columns)
